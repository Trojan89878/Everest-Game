...
def gameLoop():
    ...
    reduceO(climber_O)
    while playing == True:
        if debug_FPS == True or debug == True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT and climber_x > 625 and jumping == False:
                    x_change = -2
                    
                if event.key == pygame.K_RIGHT and climber_x < 1597 and jumping == False:
                    x_change = 2
        ...
        if climber_x < 1597 and x_change < 0 and jumping == False and x_change != 0:
            climber_slope_change = (4.5 - (climber_slope * 2))
            climber_x -= climber_slope_change
            
        elif climber_x > 625 and x_change > 0 and jumping == False and x_change != 0:
        ...
        if debug_loco == True or debug == True:
        ...
        if debug_lines == True or debug == True:
            x = 0
